...
import paymentStratergyPattern.ConcretePaymentStratergies.CashPayment;
import paymentStratergyPattern.ConcretePaymentStratergies.CreditCardPayment;
import paymentStratergyPattern.ConcretePaymentStratergies.PaypalPayment;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Register user
        User user1 = new User("ABC" , "abc@gmail.com",123);
        User user2 = new User( "BCD" , "bcd@yahoo.com",345);
        ...
        PaymentStratergy paymentStrategy;
        switch (choice) {
            case 1:
